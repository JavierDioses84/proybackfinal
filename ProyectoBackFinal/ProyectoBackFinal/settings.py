"""
Django settings for ProyectoBackFinal project.
...
# SECRET_KEY = 'django-insecure-*il*09*=fsus+-gkqark68*4udhws(kx!ho!f5o&un=tilhowp'
...
ROOT_URLCONF = 'ProyectoBackFinal.urls'
...
WSGI_APPLICATION = 'ProyectoBackFinal.wsgi.application'
